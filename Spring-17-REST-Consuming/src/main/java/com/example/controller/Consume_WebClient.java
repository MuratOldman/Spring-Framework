...
//    public Mono<MovieCinema> findCinemaById(@PathVariable("id") Long id){
//        return Mono.just(movieCinemaRepository.findById(id).get());
//    }

    @GetMapping("/mono-movie-cinema/{id}")
    public ResponseEntity<Mono<MovieCinema>> findCinemaById(@PathVariable("id") Long id){
    ...
    public Mono<Void> deleteGenreById(@PathVariable Long id){
        genreRepository.deleteById(id);
        return Mono.empty();
        // in this case we did not return anything
    }
